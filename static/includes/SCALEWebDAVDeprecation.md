...
To create new or migrate existing WebDAV sharing configurations, see the [**webdav** application tutorial]({{< relref "/SCALE/SCALETutorials/Apps/CommunityApps/WebDAV.md" >}})
{{< /hint >}}
